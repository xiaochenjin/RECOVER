...
#cpdef list compute(list atom_infor_list,list cell_geometry,int K_raw,list neigh_dis,float lc):
def compute(atom_infor_list,cell_geometry,K_raw,neigh_dis,lc):
	cdef int N_total 
